<template>
  <div class="max-w-none mx-auto px-4 py-8 w-full overflow-hidden">
    <div class="max-w-6xl mx-auto">
      <h1 class="text-2xl font-semibold text-center">Relationship — Extended</h1>
      <p class="text-gray-300 mt-1 text-center">Draw cards one by one. Use the toggles to automatically shuffle and/or cut before each draw.</p>
  ...
  <ChatPanelLauncher v-if="drawnCount > 0" :cards="promptCards" :positions="positions.slice(0, drawnCount)" spread="Relationship — Extended" />
</template>
